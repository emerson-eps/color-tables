...
export const Canvas = React.memo(
  React.forwardRef<HTMLCanvasElement, Omit<CanvasProps, "ref">>(function Canvas(
    { drawCallback, onResize, ...props },
    externalRef
  ) {
    ...
    const setRef = React.useCallback(
      (node: HTMLCanvasElement | null) => {
        ...
        if (typeof externalRef === "function") {
          ...
          (externalRef as { current: HTMLCanvasElement | null }).current = node;
        }
      },
      [externalRef]
    );
