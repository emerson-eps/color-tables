...
export const LegendContinous: React.FC<legendProps> = ({
    ...
    function colortableLegend(selected_id: string,colorscale: Record<string, (num: number) => string>) {
        ...
        var data1 = d3.range(10).map(d=> ({color:colorscale.Blues(d/10), value:d}))
