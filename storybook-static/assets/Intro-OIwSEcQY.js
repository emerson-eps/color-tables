import{j as e}from"./index-Ck88BZNf.js";import{u as r,d as l}from"./blocks-DkO8rXFl.js";import"./iframe-BXs7U1EJ.js";import"./preload-helper-DOST-yEC.js";import"./index-DOlcX2zo.js";function t(n){const o={h1:"h1",h3:"h3",p:"p",...r(),...n.components};return e.jsxs(e.Fragment,{children:[e.jsx(l,{title:"Overview"}),`
...
`,e.jsx(o.p,{children:"The continuous legend consists of a color ramp and a numeric scale indicating color values. The main props for this legend are value range(min and max), colortables(contains point and color) and few other optional parameter."}),`
`,e.jsx(o.h3,{id:"discrete-legend-component",children:"Discrete Legend component"}),`
`,e.jsx(o.p,{children:"The discrete legends display a discrete list of elements in the given hierarchy. The main props for this legend are data(discreteData), colortables(contains point and color) and few other optional parameter."}),`
...
`,e.jsx(o.p,{children:"The legendCommonFunction file consist of all the common function used by the legends and it has function for color sampling, interpolation, color mapping and so on."})]})}function h(n={}){const{wrapper:o}={...r(),...n.components};return o?e.jsx(o,{...n,children:e.jsx(t,{...n})}):t(n)}export{h as default};
